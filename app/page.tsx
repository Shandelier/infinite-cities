...
export default function GlobePage() {
  ...
  return (
    <div className="globe-page">
      ...
      <div className="globe-container" style={{ width: '100%', height: viewport.height }}>
        {isMounted && (
          <Suspense fallback={null}>
            <Globe
              ...
              pointAltitude={(p: any) =>
                hovered === (p as LocationPoint)
                  ? 0.15
                  : (p as LocationPoint).name === 'Warsaw'
                    ? 0.12
                    : 0.05
              }
              pointColor={(p: any) =>
                hovered === (p as LocationPoint)
                  ? '#ffffff'
                  : (p as LocationPoint).color || '#ffdd00'
              }
              pointRadius={(p: any) =>
                hovered === (p as LocationPoint)
                  ? 0.5
                  : (p as LocationPoint).size || 0.3
              }
