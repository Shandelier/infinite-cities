...
export default function GlobePage() {
    ...
    () => [
      {
        ...
        name: 'Warsaw',
        beforeImage: {
          src: '/images/urban/pawia.png',
          alt: 'Warsaw today',
          label: 'Present Day',
        },
        afterImage: {
          src: '/images/urban/pawia-punk.webp',
          alt: 'Warsaw solarpunk future',
      ...
      },
      {
        ...
        afterImage: {
          ...
          alt: 'Las Vegas solarpunk future',
          label: 'Solarpunk Future',
        },
      },
      {
        ...
        beforeImage: {
          ...
          alt: 'Downtown Vegas today',
          label: 'Present Day',
        },
        afterImage: {
          src: '/images/urban/vegas2.png',
          alt: 'Downtown Vegas solarpunk future',
          label: 'Solarpunk Future',
        },
      },
      {
  ...
  const pointsData = useMemo(() => locations, [locations])
  ...
  const handleBackgroundClick = () => setSelectedPoint(null)
        ...
        {isMounted && (
          <Suspense fallback={null}>
            <Globe
              ...
              pointAltitude={(p: any) => ((p as LocationPoint).name === 'Warsaw' ? 0.12 : 0.05)}
              pointColor={(p: any) => (p as LocationPoint).color || '#ff8c00'}
              pointRadius={(p: any) => (p as LocationPoint).size || 0.3}
              onPointClick={(p: any) => setSelectedPoint(p as LocationPoint)}
            />
          </Suspense>
        )}
      </div>
        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
              <h2 style={{ fontSize: 20, margin: 0 }}>{selectedPoint.name}</h2>
              <button
            ...
            <ImageComparison
              beforeImage={selectedPoint.beforeImage}
              afterImage={selectedPoint.afterImage}
            />
          </div>
        </div>
      )}
